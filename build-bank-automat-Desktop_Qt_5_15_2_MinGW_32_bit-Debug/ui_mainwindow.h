...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setGeometry(QRect(360, 120, 455, 181));
        QFont font;
        font.setPointSize(20);
        label->setFont(font);
        formLayoutWidget = new QWidget(centralwidget);
        formLayoutWidget->setObjectName(QString::fromUtf8("formLayoutWidget"));
        formLayoutWidget->setGeometry(QRect(570, 430, 591, 171));
        ...
        kirjauduNappi->setObjectName(QString::fromUtf8("kirjauduNappi"));
        ...
        Credit->setGeometry(QRect(140, 180, 271, 231));
        Credit->setStyleSheet(QString::fromUtf8("QPushButton {\n"
"    border-image: url(:/credit);\n"
"}"));
